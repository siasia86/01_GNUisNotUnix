...
if [ ! -d "/sjdir_vol1/mdf" ]; then mkdir -p /sjdir_vol1/mdf ; chown mssql.mssql -R /sjdir_vol1/ ;fi
if [ ! -d "/sjdir_vol1/ldf" ]; then mkdir -p /sjdir_vol1/ldf ; chown mssql.mssql -R /sjdir_vol1/ ;fi

if [ ! -d "/sjdir_vol2/mdf" ]; then mkdir -p /sjdir_vol2/mdf ; chown mssql.mssql -R /sjdir_vol2/ ;fi
if [ ! -d "/sjdir_vol2/ldf" ]; then mkdir -p /sjdir_vol2/ldf ; chown mssql.mssql -R /sjdir_vol2/ ;fi

if [ ! -d "/sjdir_vol3/mdf" ]; then mkdir -p /sjdir_vol3/mdf ; chown mssql.mssql -R /sjdir_vol3/ ;fi
if [ ! -d "/sjdir_vol3/ldf" ]; then mkdir -p /sjdir_vol3/ldf ; chown mssql.mssql -R /sjdir_vol3/ ;fi

if [ ! -d "/sjdir_vol4/mdf" ]; then mkdir -p /sjdir_vol4/mdf ; chown mssql.mssql -R /sjdir_vol4/ ;fi
if [ ! -d "/sjdir_vol4/ldf" ]; then mkdir -p /sjdir_vol4/ldf ; chown mssql.mssql -R /sjdir_vol4/ ;fi

if [ ! -d "/sjdir_backup/data" ]; then mkdir -p /sjdir_backup/data ; chown mssql.mssql -R /sjdir_backup/ ;fi
...
## configuration file
/opt/mssql/bin/mssql-conf set filelocation.defaultdatadir		/sjdir_vol1/mdf
/opt/mssql/bin/mssql-conf set filelocation.defaultlogdir		/sjdir_vol2/ldf
/opt/mssql/bin/mssql-conf set filelocation.defaultbackupdir		/sjdir_backup/data
...
/opt/mssql/bin/mssql-conf set filelocation.masterdatafile		/sjdir_vol3/mdf/master.mdf
/opt/mssql/bin/mssql-conf set filelocation.masterlogfile		/sjdir_vol4/ldf/mastlog.ldf
